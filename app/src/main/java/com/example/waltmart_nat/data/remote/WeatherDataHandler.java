package com.example.waltmart_nat.data.remote;
...
import static com.example.waltmart_nat.data.local.Constants.FEATURE_10_DAY_HOURLY;
import static com.example.waltmart_nat.data.local.Constants.FEATURE_CURRENT_CONDITIONS;
import static com.example.waltmart_nat.data.local.Constants.TAG_WEATHER_HANDLER;
import static com.example.waltmart_nat.data.local.Constants.URL_SCHEME_HTTP;
import static com.example.waltmart_nat.data.local.Constants.WEATHER_UNDERGROUND_BASE_URL;
import static com.example.waltmart_nat.data.local.Constants.WEATHER_UNDERGROUND_FEATURE_CONDITIONS;
import static com.example.waltmart_nat.data.local.Constants.WEATHER_UNDERGROUND_FEATURE_HOURLY_10_DAY;
import static com.example.waltmart_nat.data.local.Constants.WEATHER_UNDERGROUND_KEY;
