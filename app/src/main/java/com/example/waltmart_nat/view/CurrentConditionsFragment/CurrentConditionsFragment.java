...
import static com.example.waltmart_nat.data.local.Constants.CURRENT_CONDITION_DISPLAY;
import static com.example.waltmart_nat.data.local.Constants.DEGREE_MARK;
import static com.example.waltmart_nat.data.local.Constants.FEELS_LIKE_DISPLAY;
import static com.example.waltmart_nat.data.local.Constants.HUMIDITY_DISPLAY;
import static com.example.waltmart_nat.data.local.Constants.WEATHER_PROFILE_PARAM;
import static com.example.waltmart_nat.data.local.Constants.WIND_INTRO_DISPLAY;
